...
(yas-define-snippets 'antlr-mode
		     '(("target" "<target name=\"${1:compile}\" ${2:other}>\n        $0\n</target>" "target" nil nil nil "/Users/abhijeetsingh/.emacs.d/snippets/antlr-mode/target" nil nil)
		       ("prop" "<property name=\"${1:name}\" value=\"${2:value}\" />\n$0" "property" nil nil nil "/Users/abhijeetsingh/.emacs.d/snippets/antlr-mode/property" nil nil)
