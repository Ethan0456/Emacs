...
(defun ethan/org-mode-setup ()
  (org-indent-mode)
  (variable-pitch-mode 1)
  (visual-line-mode 1))

(defun ethan/org-mode-visual-fill ()
...
(defun ethan/org-babel-tangle-config ()
...
(add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'ethan/org-babel-tangle-config)))
